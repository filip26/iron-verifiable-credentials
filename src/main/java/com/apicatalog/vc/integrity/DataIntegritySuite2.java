...
public final class DataIntegritySuite2 implements SignatureSuite {
...
//                key -> key.length == 32
    ...
    protected DataIntegritySuite2(Map<String, CryptoSuite> crypto) {
        this.crypto = crypto;
    }
    
    public static final DataIntegritySuite2 getInstance(CryptoSuite suite) {
        //TODO
        return null;
    }
