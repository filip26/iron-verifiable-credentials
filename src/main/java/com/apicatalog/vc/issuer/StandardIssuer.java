...
public class StandardIssuer extends BaseIssuer {

    protected StandardIssuer(KeyPair keyPair, SignatureSuite suite, DocumentLoader loader) {
        super(keyPair, loader);
    }

    @Override
    public JsonObject sign(JsonStructure context, JsonObject data, Proof draft) throws SigningError {
...
//
//    public StandardIssuer(URI location, KeyPair keyPair, final Proof draft) {
...
//    }
//
//    public StandardIssuer(JsonObject document, KeyPair keyPair, final Proof draft) {
...
//     */
//    public StandardIssuer selectors(Collection<JsonPointer> selectors) {
...
//
//        final JsonObject unsignedDraft = draft.getSignature() != null 
//                ? draft.unsignedCopy()
//                : draft.toJsonLd();
//
//        final LinkedDataSignature ldSignature = new LinkedDataSignature(draft.getCryptoSuite(), loader);
//
