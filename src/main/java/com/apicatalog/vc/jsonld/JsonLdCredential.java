...
public class JsonLdCredential extends JsonLdVerifiable implements Credential  {
    ...
    protected JsonLdCredential(ModelVersion version, JsonObject expanded) {
...
//    }
    ...
    public static JsonLdCredential of(ModelVersion version, JsonObject document) throws DocumentError {
        if (document == null) {
