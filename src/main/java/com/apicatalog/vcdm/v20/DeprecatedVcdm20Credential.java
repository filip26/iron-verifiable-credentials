...
public class DeprecatedVcdm20Credential extends DeprecatedVcdmCredential implements Credential {
    ...
    protected DeprecatedVcdm20Credential() {
        // protected
    }

    public static Credential of(LinkedFragment source) throws NodeAdapterError {
        var credential = new DeprecatedVcdm20Credential();
//        VcdmCredential.setup(credential, source);
        return setup(credential, source);
    }

    protected static DeprecatedVcdm20Credential setup(DeprecatedVcdm20Credential credential, LinkedFragment source) throws NodeAdapterError {
